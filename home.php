...
<section class="cta3">
    <div class="row collapse">
        <div class="large-8 columns collapse">
            ...
            <div class="row collapse">
                ...
                <div class="large-9 columns collapse project">
                    <a href="project.php"><h4>Pelicans - Event Planning Application</h4></a>
                    <p class="left"><strong>Team Needs:</strong></p>
                    <ul class="inline-list list">
                        <li><p>Developers, </p></li>
                        <li><p>Engineers</p></li>
                    </ul>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur blanditiis est impedit minima neque nulla numquam sapiente sunt! Accusantium dicta!</p>
                    <p><span>Team of 2</span></p>
                </div>
                <hr/>
            </div>
            ...
            <div class="row collapse">
                ...
                <div class="large-9 columns collapse project">
                    <a href="project.php"><h4>Dada5 - HTML5 Javascript game</h4></a>
                    <p class="left"><strong>Team Needs:</strong></p>
                    <ul class="inline-list list">
                        <li><p>Developers, </p></li>
                        <li><p>Designers, </p></li>
                        <li><p>Concept Artists</p></li>
                    </ul>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur blanditiis est impedit minima neque nulla numquam sapiente sunt! Accusantium dicta!</p>
                    <p><span>Team of 3</span></p>
                </div>
                <hr/>
            </div>
        ...
        <div class="large-4 columns right">
            <div class="row">
                <div class="large-4 columns"></div>
                <div class="large-8 column panelGray widget-head">
